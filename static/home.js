...
window.onscroll=function () {
   ...
   if (window.innerWidth >=1024) {
    ...
    if (scrollY >= 579.3333129882812) {
        ...
        pigmenu.style.top ='10vh'
    }else{
        let pigmenu = document.querySelector('.pig-menu')
        pigmenu.style.position ='absolute'
        pigmenu.style.top ='0vh'
    }
   } else{
    if (scrollY>20) {
        let pigmenu = document.querySelector('.pig-menu')
        ...
        pigmenu.style.top ='10vh'
            ...
            disLeft.style.marginTop='250px'
            disright.style.marginTop='-190px'
        }else{
            disLeft.style.marginTop='90%'
            disright.style.marginTop='7px'
        }
...
function litle(element) {
 ...
 let titleprod = document.querySelector('.title-ord')
 ...
 imgOrd.onclick = function () {
    ...
    titleprod.style.display = 'block'
    pigPige.style.width = "100%"
    pigPige.style.height = "100vh"
    pigPige.style.position = "fixed"
